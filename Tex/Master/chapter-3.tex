...
\item{\bf cling}
臭いに対し，鼻を近づけ嗅いでいる状態．sniffのより詳細な状態であり，clingがラベル付される際はsniffと必ず重複する(図~\ref{sniff})．
\item{\bf command}
...
\\  %%%%%%%%%%%%%%%%
      ...
      \end{minipage}
    \end{tabular}
    \caption{サイバーレスキュー犬訓練データセットsniffクラス,clingクラス．}
    \label{sniff}
\end{figure}
...
\\  %%%%%%%%%%%%%%%%
      ...
      \end{minipage}
    \end{tabular}
    \caption{サイバーレスキュー犬訓練データセットstopクラス．同じクラス内の違いが顕著に表れている．同時にAとBで周波数が異なるものの静止画像，optical flow画像，音声共に均一なノイズが入っている点で共通していることも判断できる．}
    \label{stop}
\end{figure}
...
整形・サンプリングによって，学習および評価に使った総フレーム数は14,581枚となった．
...
これは，4頭の犬の背中にGoProカメラを取り付けて散歩をした動画を単一クラス分けしたデータセット~(図\ref{DCAD_image})である．動画は320 x 240 解像度，48 frames per secondで撮影されている．
...
\\
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RD001.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RD002.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RD003.eps}
       \hspace{0.1cm} {Drink}
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RD004.eps}
       \hspace{1.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RD005.eps}
       \hspace{1.6cm} { }
      \end{center}
     \end{minipage}
...
\\
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KF001.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KF002.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KF003.eps}
       \hspace{0.1cm} {Feed}
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KF004.eps}
       \hspace{1.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KF005.eps}
       \hspace{1.6cm} { }
      \end{center}
     \end{minipage}
\\
...
\\
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HR001.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HR002.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HR003.eps}
       \hspace{0.1cm} {Look\_at\_Right}
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HR004.eps}
       \hspace{1.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HR005.eps}
       \hspace{1.6cm} { }
      \end{center}
     \end{minipage}
...
\\
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KP001.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KP002.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KP003.eps}
       \hspace{0.1cm} {Pet}
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KP004.eps}
       \hspace{1.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/KP005.eps}
       \hspace{1.6cm} { }
      \end{center}
     \end{minipage}
...
\\
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HB001.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HB002.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HB003.eps}
       \hspace{0.1cm} {Play\_with\_ball}
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HB004.eps}
       \hspace{1.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/HB005.eps}
       \hspace{1.6cm} { }
      \end{center}
     \end{minipage}
...
\\
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RS001.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RS002.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RS003.eps}
       \hspace{0.1cm} {Shake}
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RS004.eps}
       \hspace{1.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RS005.eps}
       \hspace{1.6cm} { }
      \end{center}
     \end{minipage}
...
\\
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RSn001.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RSn002.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RSn003.eps}
       \hspace{0.1cm} {Sniff}
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RSn004.eps}
       \hspace{1.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RSn005.eps}
       \hspace{1.6cm} { }
      \end{center}
     \end{minipage}
...
\\
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RW001.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RW002.eps}
       \hspace{0.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RW003.eps}
       \hspace{0.1cm} {Walk}
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RW004.eps}
       \hspace{1.3cm} { }
      \end{center}
     \end{minipage}
     \begin{minipage}{0.18\hsize}
      \begin{center}
       \includegraphics[clip, width=2.5cm]{./Figures/RW005.eps}
       \hspace{1.6cm} { }
      \end{center}
     \end{minipage}
